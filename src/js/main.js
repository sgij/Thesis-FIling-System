...
class ModernFilingSystem {
    ...
    updateStats() {
        ...
        const downloadsCount = this.getDownloadsTodayCount();
        ...
        if (dashDownloadsToday) dashDownloadsToday.textContent = downloadsCount;
...
export default ModernFilingSystem;
